...
# team 38 data for ds4a
land_cover                = pd.read_csv(path + "LandCover.csv",               encoding = 'unicode_escape');
forestland                = pd.read_csv(path + "Forestland.csv",              encoding = 'unicode_escape');
crops_livestocks_products = pd.read_csv(path + "CropsLivestocksProducts.csv", encoding = 'unicode_escape');
forestloss                = pd.read_csv(path + "forestloss.csv",              encoding = 'unicode_escape');
forestgain                = pd.read_csv(path + "Forestgain.csv",              encoding = 'unicode_escape');
...
app.layout = html.Div([
    ...
    html.Div([
        html.H1(children='COREST'),
        html.Label('We are interested in searching which are the main problems of deforestation in Colombia. Here we can see explicitly the changes along each year from 1990 to 2020.', 
